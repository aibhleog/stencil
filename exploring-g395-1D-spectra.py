'''
This is code I'm using to explore 1D spectroscopy part of the IFU cubes and 
gain experience with the relevant coding software I need to use for these data.
...
# --------
name = 'S1723'
data, header = fits.getdata(path+'SGAS1723/Level3_g395h-f290lp_s3d_BW.fits', header=True) # S1723
error = fits.getdata(path+'SGAS1723/Level3_g395h-f290lp_s3d_BW.fits',ext=2) # S1723
